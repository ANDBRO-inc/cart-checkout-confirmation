...
class Checkout_Confirm_Public
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/checkout-confirm-public.js', array('jquery'), $this->version, false);
        if (is_checkout()) {
    ...
    public function define_variable_checkout_confirm()
    {
        ...
        $script .= '<script>var title_langague = "<strong>' . esc_html__('Confirm order', 'cart-checkout-confirmation') . '</strong>"; var confirm_button = "' . esc_html__('Confirm', 'checkout-confirm') . '"; var back_button = "' . esc_html__('Back', 'checkout-confirm') . '";</script>';
